				@if (strstr($_SERVER["REQUEST_URI"],'create'))
					<div class="form-group">
						<label for="subneg" class="col-sm-6 control-label">Seleccione si es control de negocio o proceso</label>
						<div class="col-sm-6">
				...
				@endif
					...
					<div class="form-group">
						{!!Form::label('Descripci&oacute;n',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						{!!Form::label('Tipo',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						{!!Form::label('Prop&oacute;sito',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						{!!Form::label('Responsable',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						{!!Form::label('Costo esperado',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						{!!Form::label('Porcentaje de contribución',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						{!!Form::label('Evidencia',null,['class'=>'col-sm-6 control-label'])!!}
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label for="file" class="col-sm-6 control-label">Cargar documentos (para seleccionar más de uno haga click en ctrl + botón izquierdo)</label>
						<div class="col-sm-6">
				...
				<!--	
					<div class="form-group">
						<label for="evidence_doc" class="col-sm-6 control-label">
