...
<div class="row">
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
			<li><a href="crear_usuario">Create User</a></li>
		</ol>
	</div>
</div>
<div class="row">
	<div class="col-sm-12 col-m-6">
		<div class="box">
			...
			@endif
			On this section you will able to create system users with distinct privileges.
			{!!Form::open(['route'=>'usuario.store','method'=>'POST','class'=>'form-horizontal'])!!}

				{!!Form::label('Choose kind',null,['class'=>'col-sm-4 control-label'])!!}
				...
				<div class="form-group" id="divpass">
					{!!Form::label('Pssword',null,['class'=>'col-sm-4 control-label'])!!}
					<div class="col-sm-3">
				...
				<div class="form-group" id="divrepass">
					{!!Form::label('Re-enter Password',null,['class'=>'col-sm-4 control-label'])!!}
					<div class="col-sm-3">
