					...
					<div id="causa">
						<div class="form-group">
							...
							<div style="cursor:hand" onclick="agregar_causa()"><font color="CornflowerBlue"><u>Add new cause</u></font></div> <br>
						</div>
					</div>
					<div id="efecto">
						<div class="form-group">
							...
							<div style="cursor:hand" onclick="agregar_efecto()"><font color="CornflowerBlue"><u>Add new effect</u></font></div> <br>
						</div>
					</div>
