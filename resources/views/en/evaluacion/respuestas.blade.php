...
<div class="row">
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
				<li><a href="evaluacion.respuestas.{{$eval_id}},{{$rut}}">View answers</a></li>
		</ol>
	</div>
</div>
<div class="row">
	<div class="col-xs-12 col-sm-8">
		<div class="box">
			...
			@endif
			<h4><center><b>Answers sent by: {{ $user->name.' '.$user->surnames }}</b></center></h4>

			@foreach($riesgos as $riesgo)
				<b>- {{ $riesgo['risk_name'] }} - {{ $riesgo['subobj'] }} - {{ $riesgo['orgproc'] }}:</b><br>
				<b><p style="color: blue;">Risk Description</b>: 
				{{ $riesgo['description'] }}</p><br>
				@foreach ($user_answers as $answer)
					@if ($answer['id'] == $riesgo['evaluation_risk_id'])
						Probability: {{ $answer['probability']}}<br>
	...
	<div class="col-xs-6 col-sm-4">
		<div class="box">
			...
			<div class="box-content box ui-draggable ui-droppable" style="top: 0px; left: 0px; opacity: 1; z-index: 1999;">
				...
				<thead>
				<th>Value</th><th>Probabilidad</th><th>Impacto</th>
				</thead>
				@for ($i=0;$i<5;$i++)
					<tr>
