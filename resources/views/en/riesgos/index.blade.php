...
@foreach (Session::get('roles') as $role)
	@if ($role != 6)
		...
		<center>
		{!! link_to_route('riesgos.create', $title = 'Create Process Risk', $parameters = 'P', $attributes = ['class'=>'btn btn-primary']) !!}
		&nbsp;&nbsp;
		{!! link_to_route('riesgos.create', $title = 'Create Bussiness Risk', $parameters = 'N', $attributes = ['class'=>'btn btn-success']) !!}
		</center>
	<?php break; ?>
