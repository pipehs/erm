...
@section('title', 'Hallazgos de prueba {{ $audit_test }}')
...
@if (isset($issues))
		...
		<h4><b>Hallazgo de prueba {{ $audit_test }}</b></h4>


		@foreach (Session::get('roles') as $role)
			@if ($role != 6)
				{!! link_to_route('create_hallazgo', $title = 'Agregar Hallazgo', $parameters = ['test'=>$audit_test_id,'kind'=>'NULL'],$attributes = ['class'=>'btn btn-success'])!!}
			<?php break; ?>
			@endif
		@endforeach
