...
function dropDown4()
{
	$uri = array('heatmap','matrices','matriz_riesgos','encuestas');
...
function dropDown6()
{
	$uri = array('auditorias','plan_auditoria','nuevo_plan','plan','ver_plan','crear_pruebas','pruebas','ejecutar_pruebas','supervisar','notas');
